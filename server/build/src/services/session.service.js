...
function reIssueAccessToken(refreshToken) {
    return __awaiter(this, void 0, void 0, function () {
        var decoded, session, user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    decoded = (0, jwt_utils_1.verifyJwt)(refreshToken).decoded;
                    if (!decoded || !lodash_1.default.get(decoded, 'session'))
                        return [2 /*return*/, false];
                    return [4 /*yield*/, session_model_1.default.findById(lodash_1.default.get(decoded, 'session'))];
                case 1:
                    session = _a.sent();
                ...
                case 2:
                    ...
                    if (!user)
                        return [2 /*return*/, false];
                    return [2 /*return*/, (0, jwt_utils_1.signJwt)(__assign(__assign({}, user), { session: session._id }), { expiresIn: config_1.default.get('accessTokenTtl') })];
            }
        });
    });
}
