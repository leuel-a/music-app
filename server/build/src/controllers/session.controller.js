    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    session = _a.sent();
                    accessToken = (0, jwt_utils_1.signJwt)(__assign(__assign({}, user), { session: session._id }), { expiresIn: config_1.default.get('accessTokenTtl') });
                    refreshToken = (0, jwt_utils_1.signJwt)(__assign(__assign({}, user), { session: session._id }), { expiresIn: config_1.default.get('refreshTokenTtl') });
